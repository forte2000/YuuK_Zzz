document.addEventListener('DOMContentLoaded', () => {
  const userId = '805390931640451072'; //replace your discord id here
  const apiUrl = `https://api.lanyard.rest/v1/users/805390931640451072`;
  ...
  async function updateDiscordStatus() {
    try {
      ...
      if (data.success) {
        ...
        const avatarUrl = `https://cdn.discordapp.com/avatars/805390931640451072/${discord.discord_user.avatar}.png`;
